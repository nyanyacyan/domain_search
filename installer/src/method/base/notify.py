...
# ----------------------------------------------------------------------------------
    ...
    async def lineDataFileNotify(self, lineToken, message, filePath):
        ...
        async with aiofiles.open(filePath, 'r', encoding='utf-8') as file:
            ...
            response = await self.apiRequest.apiRequest(method='post', endpointUrl=lineEndPoint, params=None, headers=headers, json=None, data=data)
...
# os.getenvにてトークンなどを呼び出す
    ...
    def chatwork_image_notify(self, chatwork_roomid: str, chatwork_notify_token: str, message: str, img_path: str):
        try:
